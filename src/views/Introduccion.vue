  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-3
      ...
      .col-md-12.col-lg-8.mb-3
        p El componente formativo “Fundamentos y procesos en calidad de 
          i software
      ...
      .video.mb-5
        <iframe width="560" height="315" src="https://www.youtube.com/embed/INou1eGPBAE?si=vVRFamZf6TiN-oTO" title="Fundamentos y procesos en calidad de software" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
